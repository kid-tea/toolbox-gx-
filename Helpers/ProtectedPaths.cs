...
public static class ProtectedPaths
{
    ...
    public static bool IsProtectedPath(string path)
    {
        ...
        try
        {
            var normalized = NormalizeDirectoryComparablePath(path);
            return Paths
                .Select(NormalizeDirectoryComparablePath)
                .Any(protectedPath => normalized.StartsWith(protectedPath, StringComparison.OrdinalIgnoreCase));
        }
        catch
        {
            return false;
    ...
    private static string NormalizeDirectoryComparablePath(string path)
    {
